...
<table>
  ...
  <tr>
    <td><image src="./screenshoot/Landing.png" alt="Home Page" width=100% ></td>
    <td><image src="./screenshoot/detailproduct.png" alt="Detail Product Page" width=100%/></td>
  </tr>
  <tr>
    <td>Home Page</td>
  ...
  <tr>
    <td><image src="./screenshoot/Product.png" alt="My Product" width=100%></td>
  ...
  <tr>
    <td><image src="./screenshoot/Sorting.png" alt="List My Product" width=100%></td>
        <td><image src="./screenshoot/checkout.png" alt="Salling Product" width=100%></td>
  </tr>
  <tr>
      <td>Sorting Product</td>
